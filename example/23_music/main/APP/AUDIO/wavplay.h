...
#define I2S_BCK_IO              (GPIO_NUM_21)               /* 设置串行时钟引脚，IIS_SCLK */
#define I2S_WS_IO               (GPIO_NUM_13)               /* 设置左右声道的时钟引脚，IIS_LRCK */
#define I2S_DO_IO               (GPIO_NUM_14)               /* IIS_SDIN */
#define I2S_DI_IO               (GPIO_NUM_47)               /* IIS_SDOUT */
#define IS2_MCLK_IO             (GPIO_NUM_NC)               /* IIS_MCLK */
