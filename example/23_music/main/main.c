...
void app_main(void)
{
    ...
    {
        lcd_clear(WHITE);                               /* 清屏 */
        lcd_show_string(30, 30, 200, 16, 16, "ESP32-S3 BOX", RED);
    ...
    text_show_string(30, 50, 200, 16, "正点原子ESP32-S3 BOX",16,0, RED);
    ...
    text_show_string(30, 130, 200, 16, "BO:PAUSE/PLAY", 16, 0, RED);
